...
id: addendum-pharma
name: Addendum — Pharma / Health
version: 1.0.0
channel: stable
min_shipctl: 0.3.0
updated_at: "2026-04-17T21:15:32.596953+00:00"
content_sha256: fd81ad7e4b6e5d337ba37b16315ac712d55d5e93fad193c24f867bf670e3ffcc
deprecated: false
replaced_by: null
yanked: false
group: addendum
tags: [addendum, pharma, hipaa, gdpr]
authors: [@elmundi/ship-core]
license: Apache-2.0
description: >-
  Regulated-vertical overlay (HIPAA, GDPR, 21 CFR Part 11). Use when bootstrapping a Ship project that matches this addendum shape, when picking a starter set with `shipctl init`, or when the addendums or presets it composes need updating.
spec:
  subkind: addendum
  applies_to: [mobile-app, web-app, api-backend]
  regulatory_frameworks: [HIPAA, GDPR, 21-CFR-Part-11, EU-AI-Act]
  addendum_id: pharma
  install_target: documentation/collections/addendum-pharma.md
---
