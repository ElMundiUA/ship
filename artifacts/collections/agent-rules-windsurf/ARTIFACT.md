...
content_sha256: de695a4088423bbe95ba877d11af0e63bf6d002b10feb02c6f9f28cb03fea7bf
deprecated: false
replaced_by: null
yanked: false
group: agent-rules
...
Windsurf reads `.windsurfrules` as plain text on every agent
turn. Paste the marker-delimited block below as the whole
file (or append to an existing `.windsurfrules`).
...
Source of truth: `collections/agent-rules-windsurf` on the Ship site.
Fetched by: `shipctl sync` or `shipctl collection fetch agent-rules-windsurf`.
