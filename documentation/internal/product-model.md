...
|---|---|---|---|
| `pattern` | A **prompt/instruction slice** for a role or lane. Versioned markdown. The agent reads it and follows it. | Role definition, invariants, steps, idempotency rules. | `role-intake`, `role-tech-architect`, `role-developer` |
