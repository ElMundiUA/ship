...
|---|---|---|---|
| `pattern` | A **prompt/instruction slice** for a role or lane. Versioned markdown. The agent reads it and follows it. | Role definition, invariants, steps, idempotency rules. | `catalog-a1-intake`, `cloud-tech-architect`, `cloud-developer` |
