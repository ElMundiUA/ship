...
export function rewriteDocLinks(source) {
  return source.replace(/\]\((\.\.\/[^)]+)\)/g, (full, relPath) => {
    ...
    const map = {
      ...
      "adoption/agent-playbook.md": "/docs/operating/morning-loop",
      "adoption/elmundi.md": "/use-cases",
      "adoption/delivery-quality-and-release-process.md": "/docs/operating/morning-loop",
      "adoption/agent-setup-contract.md": "/docs/discovery",
      "adoption/agent-launch-matrix.md": "/roadmap",
