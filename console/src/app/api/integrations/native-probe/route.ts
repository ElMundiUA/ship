/**
 * POST /api/integrations/native-probe — refresh native provider health.
 */
...
export async function POST(request: Request) {
  ...
  try {
    await probeNativeIntegration(wsId, installationId);
  } catch (err) {
  ...
  url.searchParams.set("native", "probed");
