/**
 * Pipeline run detail — observability for a single `PipelineRun` row
 * (status, summary, callback metrics from `shipctl`, dispatch note).
 */
  ...
  return (
    ...
    >
      <div className="mb-6 max-w-2xl text-xs text-white/55">
        <Link href="/pipelines" className="font-semibold text-aqua hover:underline">
          Pipelines
        </Link>
