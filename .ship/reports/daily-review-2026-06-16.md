...
- **ELS-309**: `validation` → `code_review` (`ready_next_step`); then **2×** `code_review` **blocked** @ 2026-06-15T07:05–07:16; PR #402 merged → Done @ 2026-06-15T09:08
...
- **25 tickets** moved via `dispatch.no_routine` (tracker poll, no agent finish); **9** confirmed Done via `tracker.event.received`

### Stuck / attention

- **ELS-309**: 2× `code_review` blocked yesterday — **resolved** (PR #402 merged; stale projection entries remain)
