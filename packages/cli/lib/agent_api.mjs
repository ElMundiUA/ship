...
// Bunny CDN occasionally fails to reach origin; the agent shouldn't
// drop a routine over a one-shot edge blip. Three attempts with
// exponential backoff. 4xx and other 5xx codes still surface on
// the first attempt.
